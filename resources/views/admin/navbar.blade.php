    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Linear Indonesia</div>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="cards.html">Spesifikasi Unit</a>
                        <a class="collapse-item" href="cards.html">Konsumen</a>
                        <a class="collapse-item" href="cards.html">Diskon</a>
                        <a class="collapse-item" href="cards.html">Pembayaran</a>
                        <a class="collapse-item" href="cards.html">Marketing </a>
            ...
            {{-- <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Laporan Perusaahaan</h6>
                        <a class="collapse-item" href="utilities-color.html">Laporan Penjualan</a>
                        <a class="collapse-item" href="utilities-border.html">Laporan Konsumen</a>
                        <a class="collapse-item" href="utilities-animation.html">Laporana Unit Rumah</a>
